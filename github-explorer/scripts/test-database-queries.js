// Import the database query functions and URL utilities
const repositoryQueries = require('../lib/database/repositories');
const contributorQueries = require('../lib/database/contributors');
const mergeRequestQueries = require('../lib/database/merge-requests');
const commitQueries = require('../lib/database/commits');
